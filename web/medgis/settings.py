"""
Django settings for medgis project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'medgis'),
        'USER': os.getenv('DB_USER', 'medgis'),
...
SHELL_PLUS_PRE_IMPORTS = (
    ('medgis.settings', ('ES_CLIENT', 'ES_INDEX_DOCUMENT', 'ES_INDEX_EMBEDDING',
